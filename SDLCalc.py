...
class Button:
    ...
    def draw(self, renderer, show_hints=True, hint_font=None):
        ...
        # Overlay d'aide (hint) en haut à droite - couleur jaune
...
def main():
    ...
    # Police display: 14px, Police boutons: 10px, Police hints: 8px (augmentée de 7 à 8)
